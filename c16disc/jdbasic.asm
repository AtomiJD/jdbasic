...
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-07-30T09:22:37
...
; program startup initialization
	...
	jsr  p8b_sprites.prog8_init_vars
	...
	jsr  p8b_callstack_f.prog8_init_vars
...
; statements
	...
	beq  label_asm_135_shortcut
	lda  p8b_ifstack.p8v_isc
	cmp  #255
	rol  a
	and  #1
	eor  #1
label_asm_135_shortcut
...
; statements
	...
	sty  p8b_main.p8v_pcode+1
	lda  #$ff
	sta  p8b_ifstack.p8v_isc
	sta  p8b_funcstack.p8v_fsc
	sta  p8b_forstack.p8v_osc
	sta  p8b_varstack.p8v_vsc
	sta  p8b_callstack_b.p8v_cbsc
	sta  p8b_callstack_w.p8v_cwsc
	jsr  p8b_error.p8s_clear
p8l_label_21_repeat
	lda  (p8b_main.p8v_pcode)
	sta  p8v_token
...
label_asm_142_afterif
	lda  p8v_token
	cmp  #117
	bne  label_asm_144_else
	jsr  p8b_runcmd.p8s_do_cls
	bra  label_asm_143_afterif
label_asm_144_else
	lda  p8v_token
	pha
...
label_asm_148_else
	lda  p8v_token
	cmp  #53
	bne  label_asm_150_else
	lda  #2
	jsr  p8b_runlang.p8s_do_let
	bra  label_asm_149_afterif
label_asm_150_else
	lda  p8v_token
	cmp  #52
...
label_asm_170_else
	lda  p8v_token
	cmp  #9
	bne  label_asm_172_else
	jsr  p8b_ifstack.p8s_pope
	bra  label_asm_171_afterif
label_asm_172_else
	lda  p8v_token
	cmp  #4
...
label_asm_202_else
	lda  p8v_token
	cmp  #205
	bne  label_asm_204_else
	jsr  p8b_runcmd.p8s_do_rect
	bra  label_asm_203_afterif
label_asm_204_else
	lda  p8v_token
	cmp  #206
	bne  label_asm_206_else
	jsr  p8b_runcmd.p8s_do_circle
	bra  label_asm_205_afterif
label_asm_206_else
	lda  p8v_token
	cmp  #209
	bne  label_asm_208_else
...
label_asm_214_else
	...
	jsr  p8b_runcx16.p8s_do_sprinit
	bra  label_asm_215_afterif
label_asm_216_else
	lda  p8v_token
	cmp  #214
	bne  label_asm_218_else
	jsr  p8b_runcx16.p8s_do_sprpos
	bra  label_asm_217_afterif
label_asm_218_else
	lda  p8v_token
	cmp  #217
	bne  label_asm_220_else
	jsr  p8b_runcx16.p8s_do_sprflip
	bra  label_asm_219_afterif
label_asm_220_else
	lda  p8v_token
	cmp  #218
	bne  label_asm_222_else
	jsr  p8b_runcx16.p8s_do_sprhide
	bra  label_asm_221_afterif
label_asm_222_else
	lda  p8v_token
	cmp  #219
	bne  label_asm_224_else
	jsr  p8b_runcx16.p8s_do_sprdata
	bra  label_asm_223_afterif
label_asm_224_else
	lda  p8v_token
	cmp  #220
	bne  label_asm_226_else
	jsr  p8b_runcx16.p8s_do_psgstart
	bra  label_asm_225_afterif
label_asm_226_else
	lda  p8v_token
	cmp  #221
	bne  label_asm_228_else
	jsr  p8b_runcx16.p8s_do_psgvoice
	bra  label_asm_227_afterif
label_asm_228_else
	lda  p8v_token
	cmp  #222
	bne  label_asm_230_else
	jsr  p8b_psg.p8s_silent
	bra  label_asm_229_afterif
label_asm_230_else
	lda  p8v_token
	cmp  #223
	bne  label_asm_232_else
	jsr  p8b_runcx16.p8s_do_psgfreq
	bra  label_asm_231_afterif
label_asm_232_else
	lda  p8v_token
	cmp  #224
	bne  label_asm_234_else
	jsr  p8b_runcx16.p8s_do_psgenv
	bra  label_asm_233_afterif
label_asm_234_else
	lda  p8v_token
	cmp  #225
	bne  label_asm_236_else
	jsr  p8b_runcx16.p8s_do_psgvol
	bra  label_asm_235_afterif
label_asm_236_else
	lda  p8v_token
	cmp  #226
	bne  label_asm_238_else
	jsr  p8b_runcx16.p8s_do_psgstop
	bra  label_asm_237_afterif
label_asm_238_else
	lda  p8v_token
	cmp  #211
	bne  label_asm_240_else
	lda  #1
	jsr  p8b_runcmd.p8s_do_bload
...
label_asm_242_else
	lda  p8v_token
	cmp  #116
	bne  label_asm_244_else
	jsr  p8b_rundos.p8s_do_load
	sta  p8v_status
	lda  p8v_status
	bne  label_asm_245_afterif
...
label_asm_244_else
	lda  p8v_token
	cmp  #114
	bne  label_asm_247_else
	jsr  p8b_rundos.p8s_do_edit
	bra  label_asm_246_afterif
label_asm_247_else
	lda  p8v_token
	cmp  #115
	bne  label_asm_249_else
	jsr  p8b_rundos.p8s_do_dir
	bra  label_asm_248_afterif
label_asm_249_else
	lda  p8v_token
	cmp  #113
...
label_asm_253_afterif
	lda  p8v_ptr
	cmp  #43
	bne  label_asm_254_afterif
	lda  #$1c
	rts
label_asm_254_afterif
	lda  p8v_ptr
	cmp  #45
...
label_asm_258_afterif
	lda  p8v_ptr
	cmp  #37
	bne  label_asm_259_afterif
	lda  #$21
	rts
label_asm_259_afterif
	lda  p8v_ptr
	cmp  #40
	bne  label_asm_260_afterif
	lda  #$22
	rts
...
label_asm_261_afterif
	lda  p8v_ptr
	cmp  #93
	bne  label_asm_262_afterif
	lda  #$24
	rts
label_asm_262_afterif
	lda  p8v_ptr
	cmp  #35
	bne  label_asm_263_afterif
	lda  #$25
	rts
...
label_asm_264_afterif
	lda  p8v_ptr
	cmp  #60
	bne  label_asm_265_afterif
	lda  #$27
	rts
label_asm_265_afterif
	lda  p8v_ptr
	cmp  #62
	bne  label_asm_266_afterif
	lda  #$28
	rts
...
label_asm_267_afterif
	lda  p8v_ptr
	cmp  #36
	bne  label_asm_268_afterif
	lda  #$2a
	rts
label_asm_268_afterif
	lda  p8v_ptr
	cmp  #39
	bne  label_asm_269_afterif
	lda  #$36
	rts
...
; non-zeropage variables
p8v_cx16_table
	.word  prog8_interned_strings.string_53, $004a, prog8_interned_strings.string_54, $004b, prog8_interned_strings.string_55, $00bc, prog8_interned_strings.string_56, $00bd, prog8_interned_strings.string_57, $00be, prog8_interned_strings.string_58, $00c9, prog8_interned_strings.string_59, $00bf, prog8_interned_strings.string_60, $00c8
	.word  prog8_interned_strings.string_61, $00cb, prog8_interned_strings.string_62, $00cc, prog8_interned_strings.string_63, $00cd, prog8_interned_strings.string_64, $00ce, prog8_interned_strings.string_65, $00cf, prog8_interned_strings.string_66, $00d0, prog8_interned_strings.string_67, $00d2, prog8_interned_strings.string_68, $00d3
	.word  prog8_interned_strings.string_69, $00d4, prog8_interned_strings.string_70, $00d5, prog8_interned_strings.string_71, $00d6, prog8_interned_strings.string_72, $00d9, prog8_interned_strings.string_73, $00da, prog8_interned_strings.string_74, $00db, prog8_interned_strings.string_75, $00dc, prog8_interned_strings.string_76, $00dd
	.word  prog8_interned_strings.string_77, $00de, prog8_interned_strings.string_78, $00df, prog8_interned_strings.string_79, $00e0, prog8_interned_strings.string_80, $00e1, prog8_interned_strings.string_81, $00e2
p8v_statements_table
	...
	.word  prog8_interned_strings.string_20, $0004, prog8_interned_strings.string_21, $0006, prog8_interned_strings.string_22, $0007, prog8_interned_strings.string_23, $0008, prog8_interned_strings.string_24, $0009, prog8_interned_strings.string_25, $000a, prog8_interned_strings.string_26, $000b, prog8_interned_strings.string_27, $000c
	.word  prog8_interned_strings.string_28, $000d, prog8_interned_strings.string_29, $000e, prog8_interned_strings.string_30, $000f, prog8_interned_strings.string_31, $0017, prog8_interned_strings.string_32, $0018, prog8_interned_strings.string_33, $002b, prog8_interned_strings.string_34, $0043, prog8_interned_strings.string_35, $0045
	.word  prog8_interned_strings.string_36, $0046, prog8_interned_strings.string_37, $0048, prog8_interned_strings.string_38, $0049, prog8_interned_strings.string_39, $004c, prog8_interned_strings.string_40, $004d, prog8_interned_strings.string_41, $00ba, prog8_interned_strings.string_42, $00bb, prog8_interned_strings.string_43, $00c0
	.word  prog8_interned_strings.string_44, $00c1, prog8_interned_strings.string_45, $00c2, prog8_interned_strings.string_46, $00c3, prog8_interned_strings.string_47, $00ca, prog8_interned_strings.string_48, $00c5, prog8_interned_strings.string_49, $00c6, prog8_interned_strings.string_47, $00ca, prog8_interned_strings.string_50, $00d1
	.word  prog8_interned_strings.string_51, $0076, prog8_interned_strings.string_52, $0077


p8s_get	.proc
p8v_statement 	= 58 	; zp UWORD
p8v_i 	= 60 	; zp UBYTE
; simple int arg(s) passed via register(s)
	sta  p8v_statement
	sty  p8v_statement+1
...
label_asm_272_afterif
	...
	lda  p8v_i
	cmp  #84
	bne  label_asm_270_for_loop
label_asm_271_for_end
	lda  #0
	sta  p8v_i
label_asm_273_for_loop
	lda  p8v_statement
	sta  cx16.r0
	lda  p8v_statement+1
	sta  cx16.r0+1
	...
	asl  a
	tay
	lda  p8b_statements.p8v_cx16_table,y
	ldx  p8b_statements.p8v_cx16_table+1,y
	stx  P8ZP_SCRATCH_REG
	ldy  P8ZP_SCRATCH_REG
	jsr  string.compare
	cmp  #0
	bne  label_asm_275_afterif
	lda  p8v_i
	clc
	adc  #1
	asl  a
...
label_asm_275_afterif
	...
	lda  p8v_i
	cmp  #58
	bne  label_asm_273_for_loop
label_asm_274_for_end
	lda  #0
	tay
	rts
; variables
...
string_56	; ISO:"locate"
	.byte  $6c, $6f, $63, $61, $74, $65, $00
string_57	; ISO:"setchr"
	.byte  $73, $65, $74, $63, $68, $72, $00
string_58	; ISO:"setclr"
...
string_67	; ISO:"bload"
	.byte  $62, $6c, $6f, $61, $64, $00
string_68	; ISO:"bvload"
	.byte  $62, $76, $6c, $6f, $61, $64, $00
string_69	; ISO:"bsave"
	.byte  $62, $73, $61, $76, $65, $00
string_7	; ISO:""
	.byte  $00
string_70	; ISO:"sprinit"
	.byte  $73, $70, $72, $69, $6e, $69, $74, $00
string_71	; ISO:"sprpos"
	.byte  $73, $70, $72, $70, $6f, $73, $00
string_72	; ISO:"sprflip"
	.byte  $73, $70, $72, $66, $6c, $69, $70, $00
string_73	; ISO:"sprhide"
	.byte  $73, $70, $72, $68, $69, $64, $65, $00
string_74	; ISO:"sprdata"
	.byte  $73, $70, $72, $64, $61, $74, $61, $00
string_75	; ISO:"psgstart"
	.byte  $70, $73, $67, $73, $74, $61, $72, $74, $00
string_76	; ISO:"psgvoice"
	.byte  $70, $73, $67, $76, $6f, $69, $63, $65, $00
string_77	; ISO:"psgsiltent"
	.byte  $70, $73, $67, $73, $69, $6c, $74, $65, $6e, $74, $00
string_78	; ISO:"psgfreq"
	.byte  $70, $73, $67, $66, $72, $65, $71, $00
string_79	; ISO:"psgenv"
	.byte  $70, $73, $67, $65, $6e, $76, $00
string_80	; ISO:"psgvol"
	.byte  $70, $73, $67, $76, $6f, $6c, $00
string_81	; ISO:"psgstop"
	.byte  $70, $73, $67, $73, $74, $6f, $70, $00
string_84	; PETSCII:"$"
	.byte  $24, $00
string_86	; PETSCII:"dir"
	.byte  $44, $49, $52, $00
string_89	; ISO:"command FLUPP testcode here."
	.byte  $63, $6f, $6d, $6d, $61, $6e, $64, $20, $46, $4c, $55, $50, $50, $20, $74, $65
	.byte  $73, $74, $63, $6f, $64, $65, $20, $68, $65, $72, $65, $2e, $00
string_91	; ISO:" in line "
	.byte  $20, $69, $6e, $20, $6c, $69, $6e, $65, $20, $00
string_92	; ISO:"none"
	.byte  $6e, $6f, $6e, $65, $00
string_93	; ISO:"Syntax Error"
	.byte  $53, $79, $6e, $74, $61, $78, $20, $45, $72, $72, $6f, $72, $00
string_94	; ISO:"Command not expected"
	.byte  $43, $6f, $6d, $6d, $61, $6e, $64, $20, $6e, $6f, $74, $20, $65, $78, $70, $65
	.byte  $63, $74, $65, $64, $00
string_95	; ISO:"Failed to load file."
	.byte  $46, $61, $69, $6c, $65, $64, $20, $74, $6f, $20, $6c, $6f, $61, $64, $20, $66
	.byte  $69, $6c, $65, $2e, $00
string_96	; ISO:"If with no endif found"
	.byte  $49, $66, $20, $77, $69, $74, $68, $20, $6e, $6f, $20, $65, $6e, $64, $69, $66
	.byte  $20, $66, $6f, $75, $6e, $64, $00
string_97	; ISO:"open function found"
	.byte  $6f, $70, $65, $6e, $20, $66, $75, $6e, $63, $74, $69, $6f, $6e, $20, $66, $6f
	.byte  $75, $6e, $64, $00
string_98	; ISO:"next not matching for"
	.byte  $6e, $65, $78, $74, $20, $6e, $6f, $74, $20, $6d, $61, $74, $63, $68, $69, $6e
	.byte  $67, $20, $66, $6f, $72, $00
string_99	; ISO:"loaded to: "
...
+
	...
	lda  cx16.r1L
	rts
label_asm_278_branch_else
	lda  cx16.r1L
	beq  label_asm_277_for_end
	dec  cx16.r1L
	bra  label_asm_276_for_loop
label_asm_277_for_end
        cli
	lda  #$ff
	rts
; variables
...
; statements
	...
	ldx  #<prog8_interned_strings.string_84
	lda  #1
	jsr  cbm.SETNAM
	ldy  #0
	...
	jsr  cbm.CHKIN
	lda  #4
	sta  label_asm_281_counter
label_asm_280_repeat
	jsr  cbm.CHRIN
	dec  label_asm_281_counter
	bne  label_asm_280_repeat
	jsr  cbm.READST
	cmp  #0
...
label_69_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_289_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_290_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_290_shortcut
label_asm_289_shortcut
...
label_70_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_293_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_294_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_294_shortcut
label_asm_293_shortcut
...
; statements
	...
	lda  p8v_a
	ldy  p8v_a+1
	sta  p8b_graphics.p8s_circle.p8v_xcenter
	sty  p8b_graphics.p8s_circle.p8v_xcenter+1
	lda  p8v_b
	sta  p8b_graphics.p8s_circle.p8v_ycenter
	
	lda  p8v_c
	sta  p8b_graphics.p8s_circle.p8v_radius
	
	jsr  p8b_graphics.p8s_circle
...
; statements
	...
	stz  p8v_to_bank
	stz  p8v_to_address
	stz  p8v_to_address+1
	jsr  p8b_main.p8s_next
	sta  p8v_r
	cmp  #45
	bne  label_asm_327_else
	...
	lda  p8v_to_address
	sta  cx16.r1
	lda  p8v_to_address+1
	sta  cx16.r1+1
	
	lda  p8v_to_bank
	jsr  diskio.vload_raw
	lda  p8b_main.p8v_pcode
	bne  +
	dec  p8b_main.p8v_pcode+1
+                           dec  p8b_main.p8v_pcode
...
p8v_xx 	= 36 	; zp UBYTE
p8v_yy 	= 37 	; zp UBYTE
p8v_decisionOver2 	= 40 	; zp WORD
; statements
	lda  p8v_radius
	bne  label_asm_328_afterif
	rts
...
p8l_label_75_whileloop
	lda  p8v_xx
	cmp  p8v_yy
	bcc  p8l_label_76_afterwhile
	ldy  p8v_xcenter+1
	lda  p8v_xcenter
	clc
	adc  p8v_xx
...
+
	...
	sta  cx16.r1
	stz  cx16.r1+1
	jsr  p8b_graphics.p8s_FB_cursor_position2
	lda  p8b_graphics.p8v_stroke_color
	jsr  cx16.FB_set_pixel
	ldy  p8v_xcenter+1
	lda  p8v_xcenter
...
+
	bra  p8l_label_75_whileloop
p8l_label_76_afterwhile
	rts
; variables
	.section BSS
	.send BSS
...
p8v_sprite_reg 	= 38 	; zp UWORD
	...
	p8c_SIZE_64 = 3
	p8c_SIZE_8 = 0
	p8c_VERA_SPRITEREGS = $fc00



p8s_init	.proc
p8v_width_flag 	= 93 	; zp UBYTE
p8v_spritenum 	= 94 	; zp UBYTE
p8v_palette_offset 	= 95 	; zp UBYTE
p8v_height_flag 	= 96 	; zp UBYTE
p8v_databank 	= 97 	; zp UBYTE
p8v_dataaddr 	= 98 	; zp UWORD
p8v_colors_flag 	= 100 	; zp UBYTE
; statements
	lda  p8v_spritenum
	jsr  p8b_sprites.p8s_hide
	lda  #64
	tsb  cx16.VERA_DC_VIDEO
	ldy  #5
-                               lsr  p8v_dataaddr+1
	ror  p8v_dataaddr
	dey
	...
	tay
	txa
	sta  p8b_sprites.p8v_sprite_reg
	sty  p8b_sprites.p8v_sprite_reg+1
	sta  cx16.r0
	lda  p8b_sprites.p8v_sprite_reg+1
	sta  cx16.r0+1
	
	ldy  p8v_dataaddr
	lda  #1
	jsr  cx16.vpoke
	ldy  p8b_sprites.p8v_sprite_reg+1
	lda  p8b_sprites.p8v_sprite_reg
	clc
	adc  #<1
	tax
	tya
...
p8s_data	.proc
p8v_spritenum 	= 102 	; zp UBYTE
p8v_bank 	= 103 	; zp UBYTE
p8v_addr 	= 104 	; zp UWORD
; statements
	ldy  #5
-                               lsr  p8v_addr+1
	ror  p8v_addr
...
p8s_hide	.proc
p8v_spritenum 	= 101 	; zp UBYTE
; simple int arg(s) passed via register(s)
	sta  p8v_spritenum
; statements
	sta  p8b_sprites.p8s_pos.p8v_spritenum
	
	lda  #<-$40
	ldy  #>-$40
	sta  p8b_sprites.p8s_pos.p8v_xpos
	sty  p8b_sprites.p8s_pos.p8v_xpos+1
	
	sta  p8b_sprites.p8s_pos.p8v_ypos
	sty  p8b_sprites.p8s_pos.p8v_ypos+1
	
	jmp  p8b_sprites.p8s_pos
; variables
	.section BSS
	.send BSS
	...
	.pend
prog8_init_vars	.block
	stz  p8b_sprites.p8v_sprite_reg
	stz  p8b_sprites.p8v_sprite_reg+1
	rts
	.bend
	.pend
...
+
	...
	tya
	sbc  p8v_r2+1
	bcs  label_asm_332_afterif
	lda  #1
	sta  p8v_r3
label_asm_332_afterif
	bra  label_asm_330_afterif
label_asm_331_else
	lda  p8v_op4
	cmp  #40
...
+
	...
	lda  p8v_op
	cmp  #$1c
	beq  label_asm_381_choice
	cmp  #$1d
	beq  label_asm_382_choice
	cmp  #10
	beq  label_asm_383_choice
	cmp  #11
	beq  label_asm_384_choice
	bra  label_asm_380_choice_end
label_asm_381_choice
	lda  p8v_t1
	clc
	adc  p8v_t2
	sta  p8v_t1
...
+
	...
	lda  p8v_opf
	cmp  #$1c
	beq  label_asm_386_choice
	cmp  #$1d
	beq  label_asm_387_choice
	cmp  #10
	beq  label_asm_388_choice
	cmp  #11
	beq  label_asm_389_choice
	bra  label_asm_385_choice_end
label_asm_386_choice
	lda  p8v_tf1
	clc
	adc  p8v_tf2
	sta  p8v_tf1
...
+
	...
	lda  p8v_opl
	cmp  #$1c
	beq  label_asm_391_choice
	cmp  #$1d
	beq  label_asm_392_choice
	cmp  #10
	beq  label_asm_393_choice
	cmp  #11
	beq  label_asm_394_choice
	bra  label_asm_390_choice_end
label_asm_391_choice
	lda  p8v_tl1
	clc
	adc  p8v_tl2
	sta  p8v_tl1
...
label_asm_397_else
	lda  p8v_op4
	cmp  #192
	bne  label_asm_399_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
	bra  label_asm_398_afterif
label_asm_399_else
	lda  p8v_op4
	cmp  #202
...
; ---- block: 'p8b_runlang' ----
p8b_runlang	.proc
p8v_funcvar 	= 106 	; zp UBYTE
p8v_funcno 	= 107 	; zp UBYTE
...
p8v_vt 	= 234 	; zp UBYTE
p8v_vn 	= 235 	; zp UBYTE
p8v_to_v 	= 236 	; zp UWORD
p8v_step_v 	= 238 	; zp UWORD
p8v_from_v 	= 240 	; zp UWORD
; statements
	stz  p8v_from_v
	stz  p8v_from_v+1
	stz  p8v_to_v
...
p8s_do_next	.proc
p8v_vt 	= 109 	; zp UBYTE
p8v_vns 	= 110 	; zp UBYTE
p8v_vn 	= 111 	; zp UBYTE
p8v_value 	= 112 	; zp UWORD
p8v_to_v 	= 114 	; zp UWORD
p8v_step_v 	= 116 	; zp UWORD
p8v_f_addr 	= 118 	; zp UWORD
; statements
	stz  p8v_vt
	stz  p8v_vn
	stz  p8v_vns
...
label_asm_415_afterif
	...
	tya
	sbc  p8v_value+1
	bcc  label_asm_419_else
	lda  p8v_vt
	cmp  #46
	bne  label_asm_421_else
	lda  p8v_value
	pha
	lda  p8v_vn
	sta  P8ZP_SCRATCH_W2
...
p8v_token 	= 250 	; zp UBYTE
p8v_toaddr 	= 251 	; zp UWORD
p8v_n_t 	= 253 	; zp UBYTE
p8v_n_i 	= 254 	; zp UBYTE
p8v_n_funcvar 	= 255 	; zp UBYTE
; simple int arg(s) passed via register(s)
	sta  p8v_lfunc
; statements
	stz  p8v_lende
	...
	lda  p8b_runlang.p8v_funcvar
	cmp  p8v_n_i
	bcc  label_asm_424_for_end
	sta  label_asm_425_for_modified+1
label_asm_423_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	jsr  p8b_callstack_w.p8s_push
	lda  p8v_n_i
label_asm_425_for_modified          cmp  #0         ; modified 
	beq  label_asm_424_for_end
	inc  p8v_n_i
	bra  label_asm_423_for_loop
label_asm_424_for_end
	stz  p8v_n_funcvar
	lda  p8v_lfunc
	beq  label_asm_428_else
	lda  p8v_lfunc
	sta  p8v_n_funcno
...
label_asm_432_else
	lda  p8v_n_funcvar
	jsr  p8b_callstack_f.p8s_push
	lda  p8v_n_funcno
	jsr  p8b_callstack_f.p8s_push
	jsr  p8b_apu.p8s_expr
	sta  p8v_cv
	sty  p8v_cv+1
	jsr  p8b_callstack_f.p8s_pop
	sta  p8v_n_funcno
	jsr  p8b_callstack_f.p8s_pop
	sta  p8v_n_funcvar
	lda  p8b_main.p8v_pcode
...
p8s_do_endfunc	.proc
p8v_toaddr 	= 242 	; zp UWORD
p8v_n_t 	= 244 	; zp UBYTE
p8v_n_i 	= 245 	; zp UBYTE
p8v_cv 	= 246 	; zp UWORD
; statements
	stz  p8v_toaddr
	stz  p8v_toaddr+1
	...
	cmp  p8v_n_i
	beq  +
	bcs  label_asm_442_for_end
+
	sta  label_asm_443_for_modified+1
label_asm_441_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	lda  p8v_n_i
label_asm_443_for_modified          cmp  #0         ; modified 
	beq  label_asm_442_for_end
	dec  p8v_n_i
	bra  label_asm_441_for_loop
label_asm_442_for_end
	lda  p8v_toaddr
	ldy  p8v_toaddr+1
	sta  p8b_main.p8v_pcode
	sty  p8b_main.p8v_pcode+1
...
p8s_do_if	.proc
p8v_thenaddr 	= 216 	; zp UWORD
p8v_m 	= 218 	; zp UBYTE
p8v_l 	= 219 	; zp UBYTE
p8v_endifaddr 	= 220 	; zp UWORD
p8v_elseaddr 	= 222 	; zp UWORD
p8v_b1 	= 224 	; zp BOOL
; statements
	stz  p8v_elseaddr
	stz  p8v_elseaddr+1
...
+
	lda  (p8b_main.p8v_pcode)
	cmp  #31
	bne  label_asm_456_else
  lda  #1
	bra  label_asm_455_afterif
label_asm_456_else
  lda  #0
label_asm_455_afterif
	beq  label_asm_454_shortcut
...
label_asm_454_shortcut
	beq  label_asm_460_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
...
+
	...
	lda  p8v_t
	cpy  p8v_j+1
	                bcc  label_asm_463_for_end
	                bne  +
	                cmp  p8v_j
	                bcc  label_asm_463_for_end
+
	sty  label_asm_464_for_modified+1
	sta  label_asm_465_for_modifiedb+1
label_asm_462_for_loop
	ldy  p8v_value+1
	lda  p8v_value
	jsr  p8b_jdheap.p8s_add_list
	lda  p8v_j+1
label_asm_464_for_modified  cmp  #0    ; modified 
	bne  +
	lda  p8v_j
label_asm_465_for_modifiedb cmp  #0    ; modified 
	beq  label_asm_463_for_end
+               inc  p8v_j
	bne  label_asm_462_for_loop
	inc  p8v_j+1
	bra  label_asm_462_for_loop
label_asm_463_for_end
label_asm_461_afterif
	bra  label_asm_459_afterif
label_asm_460_else
	lda  p8b_main.p8v_pcode
	bne  +
	dec  p8b_main.p8v_pcode+1
...
p8s_do_let	.proc
p8v_vartype 	= 120 	; zp UBYTE
p8v_r 	= 121 	; zp UBYTE
p8v_value 	= 212 	; zp UWORD
p8v_mt 	= 214 	; zp UBYTE
p8v_i 	= 215 	; zp UBYTE
; simple int arg(s) passed via register(s)
	sta  p8v_vartype
; statements
	...
	lda  (p8b_main.p8v_pcode)
	cmp  #71
	bne  label_asm_471_else
	jsr  p8b_apu.p8s_expr_l
	sta  p8v_value
	sty  p8v_value+1
	bra  label_asm_470_afterif
label_asm_471_else
	lda  p8v_vartype
	cmp  #2
...
label_asm_470_afterif
	...
	sta  p8v_vartype
	cmp  #1
	bne  label_asm_475_else
	lda  p8v_mt
	cmp  #174
	bne  label_asm_477_else
	lda  p8v_i
	sta  p8b_jdlocal.p8s_set_value.p8v_index
...
; non-zeropage variables
p8v_txttable	.word  prog8_interned_strings.string_92, prog8_interned_strings.string_93, prog8_interned_strings.string_94, prog8_interned_strings.string_95, prog8_interned_strings.string_96, prog8_interned_strings.string_97, prog8_interned_strings.string_98
...
; statements
	...
	sta  p8v_g
	lda  p8v_a
	sta  p8b_sprites.p8s_init.p8v_spritenum
	
	lda  p8v_b
	sta  p8b_sprites.p8s_init.p8v_databank
	
	lda  p8v_c
	ldy  p8v_c+1
	sta  p8b_sprites.p8s_init.p8v_dataaddr
	sty  p8b_sprites.p8s_init.p8v_dataaddr+1
	lda  p8v_d
	sta  p8b_sprites.p8s_init.p8v_width_flag
	
	lda  p8v_e
	sta  p8b_sprites.p8s_init.p8v_height_flag
	
	lda  p8v_f
	sta  p8b_sprites.p8s_init.p8v_colors_flag
	
	lda  p8v_g
	sta  p8b_sprites.p8s_init.p8v_palette_offset
	
	jsr  p8b_sprites.p8s_init
...
; statements
	...
	lda  p8v_b
	sta  p8b_sprites.p8s_pos.p8v_xpos
	stz  p8b_sprites.p8s_pos.p8v_xpos+1
	lda  p8v_c
	sta  p8b_sprites.p8s_pos.p8v_ypos
	stz  p8b_sprites.p8s_pos.p8v_ypos+1
	jsr  p8b_sprites.p8s_pos
...
; statements
	...
	sty  p8v_c+1
	lda  p8v_a
	sta  p8b_sprites.p8s_data.p8v_spritenum
	
	lda  p8v_b
	sta  p8b_sprites.p8s_data.p8v_bank
	
	lda  p8v_c
	ldy  p8v_c+1
	sta  p8b_sprites.p8s_data.p8v_addr
	sty  p8b_sprites.p8s_data.p8v_addr+1
	jsr  p8b_sprites.p8s_data
...
p8s_do_psgstart	.proc
; statements
	sec
	jsr  cx16.enable_irq_handlers
	ldy  #>p8b_psg.p8s_envelopes_irq
	lda  #<p8b_psg.p8s_envelopes_irq
	jmp  cx16.set_vsync_irq_handler
; variables
	.section BSS
	.send BSS
...
; statements
	...
	sta  p8v_e
	lda  p8v_a
	sta  p8b_psg.p8s_voice.p8v_voice_num
	
	lda  p8v_b
	sta  p8b_psg.p8s_voice.p8v_channel
	
	lda  p8v_c
	sta  p8b_psg.p8s_voice.p8v_vol
	
	lda  p8v_d
	sta  p8b_psg.p8s_voice.p8v_waveform
	
	lda  p8v_e
	sta  p8b_psg.p8s_voice.p8v_pulsewidth
	
	jsr  p8b_psg.p8s_voice
...
; statements
	...
	sty  p8v_b+1
	lda  p8v_a
	sta  p8b_psg.p8s_freq.p8v_voice_num
	
	lda  p8v_b
	ldy  p8v_b+1
	sta  p8b_psg.p8s_freq.p8v_vera_freq
	sty  p8b_psg.p8s_freq.p8v_vera_freq+1
	jsr  p8b_psg.p8s_freq
...
; statements
	...
	sta  p8v_e
	lda  p8v_a
	sta  p8b_psg.p8s_envelope.p8v_voice_num
	
	lda  p8v_b
	sta  p8b_psg.p8s_envelope.p8v_maxvolume
	
	lda  p8v_c
	sta  p8b_psg.p8s_envelope.p8v_attack
	
	lda  p8v_d
	sta  p8b_psg.p8s_envelope.p8v_sustain
	
	lda  p8v_e
	sta  p8b_psg.p8s_envelope.p8v_release
	
	jsr  p8b_psg.p8s_envelope
...
; non-zeropage variables without initialization value
	.section BSS
p8v_envelope_attacks	.fill  16
p8v_envelope_maxvolumes	.fill  16
p8v_envelope_releases	.fill  16
p8v_envelope_states	.fill  16
p8v_envelope_sustains	.fill  16
p8v_envelope_volumes_lsb	.fill  16
p8v_envelope_volumes_msb	.fill  16
	.send BSS
...
; statements
	ldy  p8v_voice_num
	lda  #$ff
	sta  p8b_psg.p8v_envelope_states,y
        php
        sei
	lda  p8v_voice_num
	asl  a
	...
	tya
	ldy  p8v_voice_num
	sta  p8b_psg.p8v_envelope_volumes_msb,y
	pla
	sta  p8b_psg.p8v_envelope_volumes_lsb,y
	ldy  p8v_voice_num
	lda  p8v_vol
	sta  p8b_psg.p8v_envelope_maxvolumes,y
        plp
	rts
; variables
	.section BSS
...
; statements
	...
	ldy  p8v_voice_num
	lda  p8v_attack
	sta  p8b_psg.p8v_envelope_attacks,y
	ldy  p8v_voice_num
	lda  p8v_sustain
	sta  p8b_psg.p8v_envelope_sustains,y
	ldy  p8v_voice_num
	lda  p8v_release
	sta  p8b_psg.p8v_envelope_releases,y
	lda  #0
	ldy  p8v_maxvolume
	sta  cx16.r0
	sty  cx16.r0+1
	ldy  p8v_voice_num
	lda  p8b_psg.p8v_envelope_volumes_lsb,y
	ldx  p8b_psg.p8v_envelope_volumes_msb,y
	sta  P8ZP_SCRATCH_W2
	stx  P8ZP_SCRATCH_W2+1
	lda  cx16.r0
	ldy  cx16.r0+1
...
label_asm_491_afterif
	...
	sta  p8b_psg.p8v_envelope_maxvolumes,y
	ldx  p8v_voice_num
	stz  p8b_psg.p8v_envelope_states,x
	rts
; variables
	.section BSS
	.send BSS
...
label_asm_492_for_loop
	...
	lda  cx16.r1L
	cmp  #16
	bne  label_asm_492_for_loop
label_asm_493_for_end
	rts
; variables
	.section BSS
	.send BSS
...
p8s_envelopes_irq	.proc
; statements
	lda  cx16.r0
	ldy  cx16.r0+1
	; inlined routine follows: pushw
            pha
            phy
	; inlined routine end: pushw
	lda  cx16.r1L
	; inlined routine follows: push
            pha
	; inlined routine end: push
	lda  cx16.r2L
	; inlined routine follows: push
            pha
	; inlined routine end: push
	...
	lda  #0
	sta  cx16.r1L
label_asm_494_for_loop
	ldy  cx16.r1L
	lda  p8b_psg.p8v_envelope_states,y
	beq  label_asm_497_choice
	cmp  #1
	beq  label_asm_498_choice
	cmp  #2
	beq  label_asm_499_choice
	bra  label_asm_496_choice_end
label_asm_497_choice
	ldy  cx16.r1L
	lda  p8b_psg.p8v_envelope_maxvolumes,y
	sta  cx16.r2L
	ldy  cx16.r1L
	lda  p8b_psg.p8v_envelope_attacks,y
	ldy  #0
	sty  P8ZP_SCRATCH_B1
	asl  a
	rol  P8ZP_SCRATCH_B1
  ...
  lda   cx16.r2L
  cmp   cx16.r0H
  bcs   label_asm_502_else
  lda  #1
	bra  label_asm_501_afterif
label_asm_502_else
  lda  #0
label_asm_501_afterif
	bne  label_asm_500_shortcut
	ldy  cx16.r1L
	lda  p8b_psg.p8v_envelope_attacks,y
	beq  +
	lda  #1
+                           eor  #1
label_asm_500_shortcut
	beq  label_asm_503_afterif
	lda  #0
	ldy  cx16.r2L
	sta  cx16.r0
	sty  cx16.r0+1
	ldx  cx16.r1L
	stz  p8b_psg.p8v_envelope_attacks,x
	ldy  cx16.r1L
	lda  #1
	sta  p8b_psg.p8v_envelope_states,y
label_asm_503_afterif
	...
	sta  p8b_psg.p8v_envelope_volumes_msb,y
	bra  label_asm_496_choice_end
label_asm_498_choice
	ldy  cx16.r1L
	lda  p8b_psg.p8v_envelope_sustains,y
	beq  label_asm_505_else
	ldx  cx16.r1L
	dec  p8b_psg.p8v_envelope_sustains,x
	bra  label_asm_504_afterif
label_asm_505_else
	ldy  cx16.r1L
	lda  #2
	sta  p8b_psg.p8v_envelope_states,y
label_asm_504_afterif
	bra  label_asm_496_choice_end
label_asm_499_choice
	ldy  cx16.r1L
	lda  p8b_psg.p8v_envelope_releases,y
	ldy  #0
	sty  P8ZP_SCRATCH_B1
	asl  a
	rol  P8ZP_SCRATCH_B1
	...
	lda  cx16.r0H
	and  #$c0
	beq  label_asm_506_afterif
	stz  cx16.r0
	stz  cx16.r0+1
	ldx  cx16.r1L
	stz  p8b_psg.p8v_envelope_releases,x
label_asm_506_afterif
	...
	lda  cx16.r0+1
	sta  p8b_psg.p8v_envelope_volumes_msb,y
label_asm_496_choice_end
	inc  cx16.r1L
	lda  cx16.r1L
	cmp  #16
	bne  label_asm_494_for_loop
label_asm_495_for_end
	jsr  cx16.save_vera_context
	stz  cx16.VERA_CTRL
	lda  #$c2
	sta  cx16.VERA_ADDR_L
	lda  #$f9
...
label_asm_507_for_loop
	...
	lda  cx16.r1L
	cmp  #16
	bne  label_asm_507_for_loop
label_asm_508_for_end
	jsr  cx16.restore_vera_context
	; inlined routine follows: popw
            ply
            pla
	; inlined routine end: popw
	sta  cx16.r9
	sty  cx16.r9+1
	; inlined routine follows: pop
            pla
	; inlined routine end: pop
	sta  cx16.r2L
	; inlined routine follows: pop
            pla
	; inlined routine end: pop
...
label_asm_509_afterif
	...
	sta  p8v_flag
	lda  p8v_flag
	beq  label_asm_513_else
	lda  #3
	jsr  p8b_error.p8s_set
	bra  label_asm_512_afterif
label_asm_513_else
	lda  #$7f
	ldy  p8v_end_address
	sty  P8ZP_SCRATCH_W2
...
+
	...
	lda  (P8ZP_SCRATCH_W1)
	cmp  #127
	bne  label_asm_518_else
  lda  #1
	bra  label_asm_517_afterif
label_asm_518_else
  lda  #0
label_asm_517_afterif
	beq  label_asm_516_shortcut
	lda  p8v_lptr
	ldy  p8v_lptr+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
; statements
	...
	sta  p8v_index
	lda  p8v_index
	bne  label_asm_566_afterif
	lda  #1
	sta  p8v_index
label_asm_566_afterif
	lda  p8v_index
	asl  a
	tay
...
; ---- block: 'p8b_callstack_f' ----
p8b_callstack_f	.proc
...
; simple int arg(s) passed via register(s)
	sta  p8v_cfvar1
; statements
	inc  p8b_callstack_f.p8v_cfsc
	ldy  p8b_callstack_f.p8v_cfsc
	lda  p8v_cfvar1
	sta  p8b_callstack_f.p8v_cfvar,y
	rts
; variables
	.section BSS
	.send BSS
...
; statements
	ldy  p8b_callstack_f.p8v_cfsc
	lda  p8b_callstack_f.p8v_cfvar,y
	sta  p8b_callstack_f.p8v_val
	dec  p8b_callstack_f.p8v_cfsc
	lda  p8b_callstack_f.p8v_val
	rts
; variables
	.section BSS
	.send BSS
