...
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-07-14T08:46:50
...
label_asm_241_afterif
	...
	lda  p8v_i
	cmp  #128
	bne  label_asm_239_for_loop
label_asm_240_for_end
	lda  #0
	tay
	rts
; variables
...
string_54	; ISO:"locate"
	.byte  $6c, $6f, $63, $61, $74, $65, $00
string_55	; ISO:"setchr"
	.byte  $73, $65, $74, $63, $68, $72, $00
string_56	; ISO:"setclr"
...
+
	...
	lda  cx16.r1L
	rts
label_asm_244_branch_else
	lda  cx16.r1L
	beq  label_asm_243_for_end
	dec  cx16.r1L
	bra  label_asm_242_for_loop
label_asm_243_for_end
        cli
	lda  #$ff
	rts
; variables
...
; statements
	...
	jsr  cbm.CHKIN
	lda  #4
	sta  label_asm_247_counter
label_asm_246_repeat
	jsr  cbm.CHRIN
	dec  label_asm_247_counter
	bne  label_asm_246_repeat
	jsr  cbm.READST
	cmp  #0
...
label_69_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_255_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_256_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_256_shortcut
...
label_70_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_259_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_260_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_260_shortcut
...
; statements
	...
	sta  p8v_v
	lda  p8b_main.p8v_graphmode
	bne  label_asm_271_else
	lda  p8v_a
	ldy  p8v_v
	jsr  txt.color2
	bra  label_asm_270_afterif
label_asm_271_else
	lda  p8v_a
	sta  p8b_main.p8v_fgcolor
...
+
	...
	inc  p8b_main.p8v_pcode+1
+
	bra  label_asm_314_afterif
label_asm_315_else
	lda  p8v_op2
	cmp  #71
	bne  label_asm_317_else
	lda  #0
	jsr  p8b_runlang.p8s_do_callfunc
	sta  p8v_r
	sty  p8v_r+1
...
+
	...
	cmp  #11
	beq  label_asm_345_choice
	bra  label_asm_341_choice_end
...
+
	...
	cmp  #11
	beq  label_asm_350_choice
	bra  label_asm_346_choice_end
...
+
	...
	cmp  #11
	beq  label_asm_355_choice
	bra  label_asm_351_choice_end
...
+
	...
	lda  #1
+                           eor  #1
	bne  label_asm_363_shortcut
	lda  p8b_apu.p8s_expr_str.p8v_co
	cmp  #<255
	bne  label_asm_365_else
...
+
	...
	lda  #1
+                           eor  #1
	bne  label_asm_367_shortcut
	lda  p8b_apu.p8s_expr_str.p8v_co
	cmp  #<255
	bne  label_asm_369_else
	lda  p8b_apu.p8s_expr_str.p8v_co+1
	cmp  #>255
	bne  label_asm_369_else
  lda  #1
	bra  label_asm_368_afterif
label_asm_369_else
  lda  #0
label_asm_368_afterif
label_asm_367_shortcut
...
p8v_vt 	= 120 	; zp UBYTE
p8v_vn 	= 121 	; zp UBYTE
p8v_to_v 	= 212 	; zp UWORD
p8v_step_v 	= 214 	; zp UWORD
p8v_from_v 	= 216 	; zp UWORD
; statements
	stz  p8v_from_v
	stz  p8v_from_v+1
	stz  p8v_to_v
...
p8v_vns 	= 59 	; zp UBYTE
p8v_vn 	= 60 	; zp UBYTE
p8v_value 	= 61 	; zp UWORD
p8v_to_v 	= 63 	; zp UWORD
p8v_step_v 	= 92 	; zp UWORD
p8v_f_addr 	= 94 	; zp UWORD
; statements
	stz  p8v_vt
	stz  p8v_vn
	stz  p8v_vns
...
p8v_token 	= 226 	; zp UBYTE
p8v_toaddr 	= 227 	; zp UWORD
p8v_n_t 	= 229 	; zp UBYTE
p8v_n_i 	= 230 	; zp UBYTE
p8v_n_funcvar 	= 231 	; zp UBYTE
p8v_n_funcno 	= 232 	; zp UBYTE
p8v_lfunc 	= 233 	; zp UBYTE
p8v_lende 	= 234 	; zp BOOL
p8v_cv 	= 235 	; zp UWORD
; simple int arg(s) passed via register(s)
	sta  p8v_lfunc
; statements
...
p8s_do_endfunc	.proc
p8v_toaddr 	= 218 	; zp UWORD
p8v_n_t 	= 220 	; zp UBYTE
p8v_n_i 	= 221 	; zp UBYTE
p8v_cv 	= 222 	; zp UWORD
; statements
	stz  p8v_toaddr
	stz  p8v_toaddr+1
	...
	cmp  p8v_n_i
	beq  +
	bcs  label_asm_403_for_end
+
	sta  label_asm_404_for_modified+1
label_asm_402_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	lda  p8v_n_i
label_asm_404_for_modified          cmp  #0         ; modified 
	beq  label_asm_403_for_end
	dec  p8v_n_i
	bra  label_asm_402_for_loop
label_asm_403_for_end
	lda  p8v_toaddr
	ldy  p8v_toaddr+1
	sta  p8b_main.p8v_pcode
	sty  p8b_main.p8v_pcode+1
...
p8s_do_if	.proc
p8v_thenaddr 	= 102 	; zp UWORD
p8v_m 	= 104 	; zp UBYTE
p8v_l 	= 105 	; zp UBYTE
p8v_endifaddr 	= 106 	; zp UWORD
p8v_elseaddr 	= 108 	; zp UWORD
p8v_b1 	= 110 	; zp BOOL
; statements
	stz  p8v_elseaddr
	stz  p8v_elseaddr+1
...
p8s_do_array	.proc
p8v_vartype 	= 237 	; zp UBYTE
p8v_value 	= 238 	; zp UWORD
p8v_t 	= 240 	; zp UWORD
p8v_r 	= 242 	; zp UBYTE
p8v_n 	= 243 	; zp UBYTE
p8v_j 	= 244 	; zp UWORD
p8v_ind 	= 246 	; zp UWORD
p8v_i 	= 248 	; zp UBYTE
; simple int arg(s) passed via register(s)
	sta  p8v_vartype
; statements
...
label_asm_415_shortcut
	beq  label_asm_421_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
...
+
	...
	cpy  p8v_j+1
	                ...
	                bcc  label_asm_424_for_end
+
	sty  label_asm_425_for_modified+1
	sta  label_asm_426_for_modifiedb+1
...
label_asm_425_for_modified  cmp  #0    ; modified 
	bne  +
	lda  p8v_j
label_asm_426_for_modifiedb cmp  #0    ; modified 
	beq  label_asm_424_for_end
+               inc  p8v_j
	bne  label_asm_423_for_loop
	inc  p8v_j+1
...
p8s_do_let	.proc
p8v_vartype 	= 96 	; zp UBYTE
p8v_value 	= 97 	; zp UWORD
p8v_r 	= 99 	; zp UBYTE
p8v_mt 	= 100 	; zp UBYTE
p8v_i 	= 101 	; zp UBYTE
; simple int arg(s) passed via register(s)
...
p8s_do_load	.proc
p8v_sbank 	= 249 	; zp UBYTE
p8v_r 	= 250 	; zp UBYTE
p8v_fname_len 	= 251 	; zp UBYTE
p8v_flag 	= 252 	; zp BOOL
p8v_end_bank 	= 253 	; zp UBYTE
p8v_end_address 	= 254 	; zp UWORD
; statements
	stz  p8v_r
	stz  p8v_fname_len
	stz  p8v_end_bank
