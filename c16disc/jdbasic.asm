...
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-07-21T10:05:42
...
label_asm_237_afterif
	lda  p8v_ptr
	cmp  #43
	bne  label_asm_238_afterif
	lda  #$1c
	rts
label_asm_238_afterif
	lda  p8v_ptr
	cmp  #45
	bne  label_asm_239_afterif
	lda  #$1d
	rts
...
label_asm_240_afterif
	lda  p8v_ptr
	cmp  #42
	bne  label_asm_241_afterif
	lda  #$1f
	rts
label_asm_241_afterif
	lda  p8v_ptr
	cmp  #47
	bne  label_asm_242_afterif
	lda  #$20
	rts
...
label_asm_256_afterif
	...
	lda  p8v_i
	cmp  #84
	bne  label_asm_254_for_loop
label_asm_255_for_end
	lda  #0
	sta  p8v_i
label_asm_257_for_loop
	lda  p8v_statement
	sta  cx16.r0
	lda  p8v_statement+1
	sta  cx16.r0+1
...
label_asm_259_afterif
	...
	lda  p8v_i
	cmp  #58
	bne  label_asm_257_for_loop
label_asm_258_for_end
	lda  #0
	tay
	rts
; variables
...
+
	...
	lda  cx16.r1L
	rts
label_asm_262_branch_else
	lda  cx16.r1L
	beq  label_asm_261_for_end
	dec  cx16.r1L
	bra  label_asm_260_for_loop
label_asm_261_for_end
        cli
	lda  #$ff
	rts
; variables
...
; statements
	...
	jsr  cbm.CHKIN
	lda  #4
	sta  label_asm_265_counter
label_asm_264_repeat
	jsr  cbm.CHRIN
	dec  label_asm_265_counter
	bne  label_asm_264_repeat
	jsr  cbm.READST
	cmp  #0
...
label_69_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_273_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_274_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_274_shortcut
label_asm_273_shortcut
...
label_70_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_277_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_278_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_278_shortcut
label_asm_277_shortcut
...
; statements
	...
	sta  p8v_v
	lda  p8b_main.p8v_graphmode
	bne  label_asm_289_else
	lda  p8v_a
	ldy  p8v_v
	jsr  txt.color2
	bra  label_asm_288_afterif
label_asm_289_else
	lda  p8v_a
	sta  p8b_main.p8v_fgcolor
...
p8s_init	.proc
p8v_width_flag 	= 62 	; zp UBYTE
p8v_spritenum 	= 63 	; zp UBYTE
p8v_palette_offset 	= 64 	; zp UBYTE
p8v_height_flag 	= 92 	; zp UBYTE
p8v_databank 	= 93 	; zp UBYTE
p8v_dataaddr 	= 94 	; zp UWORD
p8v_colors_flag 	= 96 	; zp UBYTE
; statements
	lda  p8v_spritenum
	jsr  p8b_sprites.p8s_hide
	lda  #64
...
p8s_data	.proc
p8v_spritenum 	= 98 	; zp UBYTE
p8v_bank 	= 99 	; zp UBYTE
p8v_addr 	= 100 	; zp UWORD
; statements
	ldy  #5
-                               lsr  p8v_addr+1
	ror  p8v_addr
...
label_asm_316_else
	...
	tya
	sbc  p8v_r1+1
	bcs  label_asm_320_afterif
	lda  #1
	sta  p8v_r3
label_asm_320_afterif
	bra  label_asm_318_afterif
label_asm_319_else
	lda  p8v_op4
	cmp  #41
	bne  label_asm_321_afterif
	stz  p8v_r3
	lda  p8b_apu.p8s_relation.p8v_r1
	cmp  p8b_apu.p8s_relation.p8v_r2
	bne  label_asm_322_afterif
...
+
	...
	sta  p8v_r
	sty  p8v_r+1
	bra  label_asm_332_afterif
label_asm_333_else
	lda  p8v_op2
	cmp  #12
	bne  label_asm_335_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
...
label_asm_347_else
	lda  p8v_op2
	cmp  #186
	bne  label_asm_349_else
	jsr  p8b_runcmd.p8s_do_get
	sta  p8v_r
	stz  p8v_r+1
	bra  label_asm_348_afterif
label_asm_349_else
	lda  p8v_op2
	cmp  #208
	bne  label_asm_351_else
	jsr  p8b_runcmd.p8s_do_get_pixel
	sta  p8v_r
	sty  p8v_r+1
	bra  label_asm_350_afterif
label_asm_351_else
	lda  p8v_op2
	cmp  #187
	bne  label_asm_353_else
...
label_asm_353_else
	lda  p8v_op2
	cmp  #191
	bne  label_asm_355_else
	jsr  p8b_runcmd.p8s_do_get_jiffi
	sta  p8v_r
	sty  p8v_r+1
	bra  label_asm_354_afterif
label_asm_355_else
	lda  p8v_op2
	cmp  #198
...
+
	...
	lda  p8v_op
	cmp  #$1c
	beq  label_asm_366_choice
	cmp  #$1d
	beq  label_asm_367_choice
	cmp  #10
	beq  label_asm_368_choice
	cmp  #11
	beq  label_asm_369_choice
	bra  label_asm_365_choice_end
label_asm_366_choice
	lda  p8v_t1
	clc
	adc  p8v_t2
	sta  p8v_t1
...
+
	...
	lda  p8v_opf
	cmp  #$1c
	beq  label_asm_371_choice
	cmp  #$1d
	beq  label_asm_372_choice
	cmp  #10
	beq  label_asm_373_choice
	cmp  #11
	beq  label_asm_374_choice
	bra  label_asm_370_choice_end
label_asm_371_choice
	lda  p8v_tf1
	clc
	adc  p8v_tf2
	sta  p8v_tf1
...
+
	...
	lda  p8v_opl
	cmp  #$1c
	beq  label_asm_376_choice
	cmp  #$1d
	beq  label_asm_377_choice
	cmp  #10
	beq  label_asm_378_choice
	cmp  #11
	beq  label_asm_379_choice
	bra  label_asm_375_choice_end
label_asm_376_choice
	lda  p8v_tl1
	clc
	adc  p8v_tl2
	sta  p8v_tl1
...
+
	...
	lda  #1
+                           eor  #1
	bne  label_asm_391_shortcut
	lda  p8b_apu.p8s_expr_str.p8v_co
	cmp  #<255
	bne  label_asm_393_else
	lda  p8b_apu.p8s_expr_str.p8v_co+1
	cmp  #>255
	bne  label_asm_393_else
  lda  #1
	bra  label_asm_392_afterif
label_asm_393_else
  lda  #0
label_asm_392_afterif
label_asm_391_shortcut
...
; ---- block: 'p8b_runlang' ----
p8b_runlang	.proc
p8v_funcvar 	= 102 	; zp UBYTE
p8v_funcno 	= 103 	; zp UBYTE
...
p8v_vt 	= 230 	; zp UBYTE
p8v_vn 	= 231 	; zp UBYTE
p8v_to_v 	= 232 	; zp UWORD
p8v_step_v 	= 234 	; zp UWORD
p8v_from_v 	= 236 	; zp UWORD
; statements
	stz  p8v_from_v
	stz  p8v_from_v+1
	stz  p8v_to_v
...
p8s_do_next	.proc
p8v_vt 	= 105 	; zp UBYTE
p8v_vns 	= 106 	; zp UBYTE
p8v_vn 	= 107 	; zp UBYTE
p8v_value 	= 108 	; zp UWORD
p8v_to_v 	= 110 	; zp UWORD
p8v_step_v 	= 112 	; zp UWORD
p8v_f_addr 	= 114 	; zp UWORD
; statements
	stz  p8v_vt
	stz  p8v_vn
	stz  p8v_vns
...
p8v_token 	= 246 	; zp UBYTE
p8v_toaddr 	= 247 	; zp UWORD
p8v_n_t 	= 249 	; zp UBYTE
p8v_n_i 	= 250 	; zp UBYTE
p8v_n_funcvar 	= 251 	; zp UBYTE
p8v_n_funcno 	= 252 	; zp UBYTE
p8v_lfunc 	= 253 	; zp UBYTE
p8v_lende 	= 254 	; zp BOOL
; simple int arg(s) passed via register(s)
	sta  p8v_lfunc
; statements
	stz  p8v_lende
	...
	lda  p8b_runlang.p8v_funcvar
	cmp  p8v_n_i
	bcc  label_asm_409_for_end
	sta  label_asm_410_for_modified+1
label_asm_408_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	jsr  p8b_callstack_w.p8s_push
	lda  p8v_n_i
label_asm_410_for_modified          cmp  #0         ; modified 
	beq  label_asm_409_for_end
	inc  p8v_n_i
	bra  label_asm_408_for_loop
label_asm_409_for_end
	stz  p8v_n_funcvar
	lda  p8v_lfunc
	beq  label_asm_413_else
	lda  p8v_lfunc
	sta  p8v_n_funcno
...
p8s_do_endfunc	.proc
p8v_toaddr 	= 238 	; zp UWORD
p8v_n_t 	= 240 	; zp UBYTE
p8v_n_i 	= 241 	; zp UBYTE
p8v_cv 	= 242 	; zp UWORD
; statements
	stz  p8v_toaddr
	stz  p8v_toaddr+1
	...
	cmp  p8v_n_i
	beq  +
	bcs  label_asm_427_for_end
+
	sta  label_asm_428_for_modified+1
label_asm_426_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	lda  p8v_n_i
label_asm_428_for_modified          cmp  #0         ; modified 
	beq  label_asm_427_for_end
	dec  p8v_n_i
	bra  label_asm_426_for_loop
label_asm_427_for_end
	lda  p8v_toaddr
	ldy  p8v_toaddr+1
	sta  p8b_main.p8v_pcode
	sty  p8b_main.p8v_pcode+1
...
p8s_do_if	.proc
p8v_thenaddr 	= 212 	; zp UWORD
p8v_m 	= 214 	; zp UBYTE
p8v_l 	= 215 	; zp UBYTE
p8v_endifaddr 	= 216 	; zp UWORD
p8v_elseaddr 	= 218 	; zp UWORD
p8v_b1 	= 220 	; zp BOOL
; statements
	stz  p8v_elseaddr
	stz  p8v_elseaddr+1
...
; statements
	...
	sta  p8v_r
	cmp  #36
	bne  label_asm_435_else
	jsr  p8b_main.p8s_next
	sta  p8v_r
	lda  (p8b_main.p8v_pcode)
	cmp  #41
	bne  label_asm_436_afterif
	jsr  p8b_main.p8s_next
	sta  p8v_r
	lda  (p8b_main.p8v_pcode)
	cmp  #35
...
+
	lda  (p8b_main.p8v_pcode)
	cmp  #31
	bne  label_asm_441_else
  lda  #1
	bra  label_asm_440_afterif
label_asm_441_else
  lda  #0
label_asm_440_afterif
	beq  label_asm_439_shortcut
...
label_asm_439_shortcut
	beq  label_asm_445_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
...
+
	...
	lda  p8v_t
	cpy  p8v_j+1
	                bcc  label_asm_448_for_end
	                bne  +
	                cmp  p8v_j
	                bcc  label_asm_448_for_end
+
	sty  label_asm_449_for_modified+1
	sta  label_asm_450_for_modifiedb+1
label_asm_447_for_loop
	ldy  p8v_value+1
	lda  p8v_value
	jsr  p8b_jdheap.p8s_add_list
	lda  p8v_j+1
label_asm_449_for_modified  cmp  #0    ; modified 
	bne  +
	lda  p8v_j
label_asm_450_for_modifiedb cmp  #0    ; modified 
	beq  label_asm_448_for_end
+               inc  p8v_j
	bne  label_asm_447_for_loop
	inc  p8v_j+1
	bra  label_asm_447_for_loop
label_asm_448_for_end
...
p8s_do_let	.proc
p8v_vartype 	= 116 	; zp UBYTE
p8v_value 	= 117 	; zp UWORD
p8v_r 	= 119 	; zp UBYTE
p8v_mt 	= 120 	; zp UBYTE
p8v_i 	= 121 	; zp UBYTE
; simple int arg(s) passed via register(s)
...
label_asm_455_afterif
	...
	sta  p8v_vartype
	cmp  #1
	bne  label_asm_460_else
	lda  p8v_mt
	cmp  #174
	bne  label_asm_462_else
	lda  p8v_i
	sta  p8b_jdlocal.p8s_set_value.p8v_index
...
label_asm_476_afterif
	...
	lda  #1
+                           eor  #1
label_asm_475_shortcut
	beq  label_asm_478_afterif
	lda  #1
	sta  p8v_lende
...
p8l_label_124_afterwhile
	...
	jsr  string.compare
	cmp  #0
	bne  label_asm_524_afterif
	lda  p8v_current
	rts
label_asm_524_afterif
	lda  #0
	rts
; variables
	.section BSS
...
; statements
	...
	sta  p8v_index
	lda  p8v_index
	bne  label_asm_530_afterif
	lda  #1
	sta  p8v_index
label_asm_530_afterif
	ldy  p8v_index
	lda  p8b_labels.p8v_label_next,y
	sta  p8v_current
	bne  label_asm_531_afterif
	lda  p8v_index
	asl  a
	tay
...
+                           eor  #1
	...
	sty  P8ZP_SCRATCH_B1
	ora  P8ZP_SCRATCH_B1
label_asm_540_shortcut
	beq  label_asm_541_afterif
	lda  p8v_index
	rts
