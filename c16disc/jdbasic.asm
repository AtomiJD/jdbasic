...
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-07-18T08:37:58
...
label_asm_242_afterif
	...
	lda  p8v_i
	cmp  #128
	bne  label_asm_240_for_loop
label_asm_241_for_end
	lda  #0
	tay
	rts
; variables
...
+
	...
	lda  cx16.r1L
	rts
label_asm_245_branch_else
	lda  cx16.r1L
	beq  label_asm_244_for_end
	dec  cx16.r1L
	bra  label_asm_243_for_loop
label_asm_244_for_end
        cli
	lda  #$ff
	rts
; variables
...
; statements
	...
	jsr  cbm.CHKIN
	lda  #4
	sta  label_asm_248_counter
label_asm_247_repeat
	jsr  cbm.CHRIN
	dec  label_asm_248_counter
	bne  label_asm_247_repeat
	jsr  cbm.READST
	cmp  #0
...
label_69_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_256_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_257_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_257_shortcut
...
label_70_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_260_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_261_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_261_shortcut
...
+
	...
	cmp  #11
	beq  label_asm_356_choice
	bra  label_asm_352_choice_end
...
; statements
	...
	lda  p8b_runlang.p8v_funcvar
	cmp  p8v_n_i
	bcc  label_asm_386_for_end
	sta  label_asm_387_for_modified+1
label_asm_385_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	jsr  p8b_callstack_w.p8s_push
	lda  p8v_n_i
label_asm_387_for_modified          cmp  #0         ; modified 
	beq  label_asm_386_for_end
	inc  p8v_n_i
	bra  label_asm_385_for_loop
label_asm_386_for_end
	stz  p8v_n_funcvar
	lda  p8v_lfunc
...
; statements
	...
	cmp  p8v_n_i
	beq  +
	bcs  label_asm_404_for_end
+
	sta  label_asm_405_for_modified+1
label_asm_403_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	lda  p8v_n_i
label_asm_405_for_modified          cmp  #0         ; modified 
	beq  label_asm_404_for_end
	dec  p8v_n_i
	bra  label_asm_403_for_loop
label_asm_404_for_end
	lda  p8v_toaddr
	ldy  p8v_toaddr+1
	sta  p8b_main.p8v_pcode
	sty  p8b_main.p8v_pcode+1
...
+
	lda  (p8b_main.p8v_pcode)
	cmp  #31
	bne  label_asm_418_else
  lda  #1
	bra  label_asm_417_afterif
label_asm_418_else
  lda  #0
label_asm_417_afterif
	beq  label_asm_416_shortcut
	lda  p8b_jdheap.p8v_ll
	cmp  #<1
	bne  label_asm_420_else
	lda  p8b_jdheap.p8v_ll+1
	cmp  #>1
	bne  label_asm_420_else
  lda  #1
	bra  label_asm_419_afterif
label_asm_420_else
  lda  #0
label_asm_419_afterif
label_asm_416_shortcut
	beq  label_asm_422_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
...
+
	...
	lda  p8v_t
	cpy  p8v_j+1
	                bcc  label_asm_425_for_end
	                bne  +
	                cmp  p8v_j
	                bcc  label_asm_425_for_end
+
	sty  label_asm_426_for_modified+1
	sta  label_asm_427_for_modifiedb+1
label_asm_424_for_loop
	ldy  p8v_value+1
	lda  p8v_value
	jsr  p8b_jdheap.p8s_add_list
	lda  p8v_j+1
label_asm_426_for_modified  cmp  #0    ; modified 
	bne  +
	lda  p8v_j
label_asm_427_for_modifiedb cmp  #0    ; modified 
	beq  label_asm_425_for_end
+               inc  p8v_j
	bne  label_asm_424_for_loop
	inc  p8v_j+1
	bra  label_asm_424_for_loop
label_asm_425_for_end
...
+                           eor  #1
	...
	sty  P8ZP_SCRATCH_B1
	ora  P8ZP_SCRATCH_B1
label_asm_517_shortcut
	beq  label_asm_518_afterif
	lda  p8v_index
	rts
