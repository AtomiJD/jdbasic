...
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-07-19T15:43:14
...
p8v_statements_table
	...
	.word  prog8_interned_strings.string_36, $0046, prog8_interned_strings.string_37, $0048, prog8_interned_strings.string_38, $0049, prog8_interned_strings.string_39, $004a, prog8_interned_strings.string_40, $004b, prog8_interned_strings.string_41, $004c, prog8_interned_strings.string_42, $004d, prog8_interned_strings.string_43, $00ba
	.word  prog8_interned_strings.string_44, $00bb, prog8_interned_strings.string_45, $00bc, prog8_interned_strings.string_46, $00bd, prog8_interned_strings.string_47, $00be, prog8_interned_strings.string_48, $00c9, prog8_interned_strings.string_49, $00bf, prog8_interned_strings.string_50, $00c0, prog8_interned_strings.string_51, $00c1
	.word  prog8_interned_strings.string_52, $00c2, prog8_interned_strings.string_53, $00c3, prog8_interned_strings.string_54, $00ca, prog8_interned_strings.string_55, $00c5, prog8_interned_strings.string_56, $00c6, prog8_interned_strings.string_57, $00c8, prog8_interned_strings.string_54, $00ca, prog8_interned_strings.string_58, $00cb
	.word  prog8_interned_strings.string_59, $00cc, prog8_interned_strings.string_60, $00cd, prog8_interned_strings.string_61, $00ce, prog8_interned_strings.string_62, $00cf, prog8_interned_strings.string_63, $00d0, prog8_interned_strings.string_64, $00d1, prog8_interned_strings.string_65, $0076, prog8_interned_strings.string_66, $0077
	.word  prog8_interned_strings.string_67, $00d2, prog8_interned_strings.string_68, $00d3, prog8_interned_strings.string_69, $00d4, prog8_interned_strings.string_70, $00d5, prog8_interned_strings.string_71, $00d6, prog8_interned_strings.string_72, $00d9, prog8_interned_strings.string_73, $00da, prog8_interned_strings.string_74, $00db
...
string_46	; ISO:"locate"
	.byte  $6c, $6f, $63, $61, $74, $65, $00
string_47	; ISO:"setchr"
	.byte  $73, $65, $74, $63, $68, $72, $00
string_48	; ISO:"setclr"
...
+
	...
	lda  cx16.r1L
	rts
label_asm_259_branch_else
	lda  cx16.r1L
	beq  label_asm_258_for_end
	dec  cx16.r1L
	bra  label_asm_257_for_loop
...
; statements
	...
	ldx  #<prog8_interned_strings.string_77
	lda  #1
	jsr  cbm.SETNAM
	ldy  #0
	...
	jsr  cbm.CHKIN
	lda  #4
	sta  label_asm_262_counter
label_asm_261_repeat
	jsr  cbm.CHRIN
	dec  label_asm_262_counter
	bne  label_asm_261_repeat
	jsr  cbm.READST
	cmp  #0
...
label_69_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_270_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_271_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_271_shortcut
...
label_70_untilloop
	...
	lda  #1
+                           eor  #1
	bne  label_asm_274_shortcut
	lda  cx16.r1L
	jsr  string.isprint
	lda  #0
	rol  a
	beq  label_asm_275_shortcut
	lda  cx16.r1L
	jsr  string.isspace
	lda  #0
	rol  a
	eor  #1
label_asm_275_shortcut
...
+
	...
	tya
	sbc  p8v_r2+1
	bcs  label_asm_314_afterif
	lda  #1
	sta  p8v_r3
label_asm_314_afterif
	bra  label_asm_312_afterif
label_asm_313_else
	lda  p8v_op4
	cmp  #40
...
+
	...
	lda  p8v_op
	cmp  #$1c
	beq  label_asm_363_choice
	cmp  #$1d
	beq  label_asm_364_choice
	cmp  #10
	beq  label_asm_365_choice
	cmp  #11
	beq  label_asm_366_choice
	bra  label_asm_362_choice_end
label_asm_363_choice
	lda  p8v_t1
	clc
	adc  p8v_t2
	sta  p8v_t1
...
+
	...
	cmp  #10
	beq  label_asm_370_choice
	cmp  #11
	beq  label_asm_371_choice
	bra  label_asm_367_choice_end
...
+
	...
	cmp  #10
	beq  label_asm_375_choice
	cmp  #11
	beq  label_asm_376_choice
	bra  label_asm_372_choice_end
...
; statements
	...
	lda  p8b_runlang.p8v_funcvar
	cmp  p8v_n_i
	bcc  label_asm_406_for_end
	sta  label_asm_407_for_modified+1
label_asm_405_for_loop
	lda  p8b_runlang.p8v_funcno
	sta  p8b_runlang.p8v_varname
	lda  p8v_n_i
	sta  p8b_runlang.p8v_varname+1
	...
	jsr  p8b_callstack_w.p8s_push
	lda  p8v_n_i
label_asm_407_for_modified          cmp  #0         ; modified 
	beq  label_asm_406_for_end
	inc  p8v_n_i
	bra  label_asm_405_for_loop
label_asm_406_for_end
	stz  p8v_n_funcvar
	lda  p8v_lfunc
	beq  label_asm_410_else
	lda  p8v_lfunc
	sta  p8v_n_funcno
...
label_asm_436_shortcut
	beq  label_asm_442_else
	inc  p8b_main.p8v_pcode
	bne  +
	inc  p8b_main.p8v_pcode+1
+
...
+
	...
	lda  p8v_t
	cpy  p8v_j+1
	                bcc  label_asm_445_for_end
	                bne  +
	                cmp  p8v_j
	                bcc  label_asm_445_for_end
+
	sty  label_asm_446_for_modified+1
	sta  label_asm_447_for_modifiedb+1
label_asm_444_for_loop
	ldy  p8v_value+1
	lda  p8v_value
	jsr  p8b_jdheap.p8s_add_list
	lda  p8v_j+1
label_asm_446_for_modified  cmp  #0    ; modified 
	bne  +
	lda  p8v_j
label_asm_447_for_modifiedb cmp  #0    ; modified 
	beq  label_asm_445_for_end
+               inc  p8v_j
	bne  label_asm_444_for_loop
	inc  p8v_j+1
	bra  label_asm_444_for_loop
label_asm_445_for_end
label_asm_443_afterif
	bra  label_asm_441_afterif
label_asm_442_else
	lda  p8b_main.p8v_pcode
	bne  +
	dec  p8b_main.p8v_pcode+1
...
; non-zeropage variables
p8v_txttable	.word  prog8_interned_strings.string_85, prog8_interned_strings.string_86, prog8_interned_strings.string_87, prog8_interned_strings.string_88, prog8_interned_strings.string_89, prog8_interned_strings.string_90, prog8_interned_strings.string_91
...
label_asm_473_afterif
	...
	lda  #1
+                           eor  #1
label_asm_472_shortcut
	beq  label_asm_475_afterif
	lda  #1
	sta  p8v_lende
...
; statements
	...
	sta  p8v_index
	lda  p8v_index
	bne  label_asm_536_afterif
	lda  #1
	sta  p8v_index
label_asm_536_afterif
	lda  p8v_index
	beq  +
	lda  #1
+                           eor  #1
